...
export default {
  ...
  theme: {
    extend: {
      animation: {
        materialize: 'materialize 0.25s linear',
      ...
      colors: {
        ...
        contrast: {
          primary: 'rgb(var(--contrast-primary) / <alpha-value>)',
          secondary: 'rgb(var(--contrast-secondary) / <alpha-value>)',
          accent: 'rgb(var(--contrast-accent) / <alpha-value>)',
          red: 'rgb(var(--contrast-red) / <alpha-value>)',
          green: 'rgb(var(--contrast-green) / <alpha-value>)',
          yellow: 'rgb(var(--contrast-yellow) / <alpha-value>)',
          blue: 'rgb(var(--contrast-blue) / <alpha-value>)',
        },
      },
    },
  },
